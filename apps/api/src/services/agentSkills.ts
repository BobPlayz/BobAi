...
const skills: AgentSkill[] = [
  ...
  { id: "vision", name: "vision", description: "Analyze screenshots and images with the configured vision capability and deterministic image metadata where supported.", kind: "capability", available: env("BOBAI_VISION_MODEL") },
